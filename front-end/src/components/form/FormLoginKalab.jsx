                ...
                <div className="flex flex-col justify-center pt-10 lg:pt-20 w-full">
                    ...
                    <div className="px-4 lg:px-40 pt-10 w-full">
                        <form action="" className="space-y-6">
                            <Input label={'NIP'} name={'nip_kalab'} placeholder={'Masukan nip akun anda'} className={'text-lg pb-2'}/>
                            <InputPass label={'Kata Sandi'} name={'password'} placeholder={'Masukan kata sandi anda'} className={'text-lg pb-2'}/>
