...
import { sideLinkKoor } from "../../../data/SideLinkKoor";
import Tooltip from '@mui/material/Tooltip';
import ActiveRoute from './ActiveRoute'
import Swal from "sweetalert2";
import LogoutKoor from "../../../api/Koordinator Asisten/LogoutKoor";
...
export default function SidebarKoor({children, profile, nama_koor}) {
