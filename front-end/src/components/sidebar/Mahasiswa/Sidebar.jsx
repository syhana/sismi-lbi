...
import { sidebarDataMhs } from '../../../data/sideLinkMhs';
import Tooltip from '@mui/material/Tooltip';
import ActiveRoute from './ActiveRoute'
import LogoutMahasiswa from "../../../api/mahasiswa/LogoutMahasiswa";
...
const openedMixin = (theme) => ({
  ...
  overflowX: 'hidden',
  background: 'linear-gradient(to bottom, #8AA0E5, #435DC7)', 
});
...
export default function SidebarMhs({children, profile, nama_mahasiswa}) {
