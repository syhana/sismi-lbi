...
import { sideLinkKalab } from "../../../data/sideLinkKalab";
import Tooltip from '@mui/material/Tooltip';
import ActiveRoute from './ActiveRoute'
import Swal from "sweetalert2";
import LogoutKalab from "../../../api/Kepala Laboratorium/LogoutKalab";
...
export default function SidebarKalab({children, profile, nama_kalab}) {
    ...
    <Box sx={{ display: 'flex'}}>
      ...
      >
        <div className="akun flex justify-end mr-10" style={{ display: 'flex', alignItems: 'center' }}>
          <a href={profile}><p className="text-black font-bold text-2xl me-5 ">{nama_kalab}</p></a>
