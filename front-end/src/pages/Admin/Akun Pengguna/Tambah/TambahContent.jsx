  ...
  return (
    <div className="p-4 md:p-10 lg:px-14">
      ...
      <form action="" className="flex flex-col space-y-5">
        <Input label={'NIP (*Jika Kepala Laboratorium)'} className={'text-primary text-base font-medium'} name={'nip_kalab'} placeholder={'Masukan NIP'} />
        <Input label={'Nama'} className={'text-primary text-base font-medium'} name={'nama'} placeholder={'Masukan Nama'} />
        <InputPass label={'Kata Sandi'} className={'text-primary text-base font-medium'} name={'password'} placeholder={'Masukan Kata Sandi'} />
